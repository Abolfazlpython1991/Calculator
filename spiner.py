...
pygame.display.set_caption("spiner : Abolfazl Eskandari")
...
def show_info(speed):
    ...
    frictionText = font.render('made by Abolfazl Eskandari', True, white)
    speedText = font.render("Speed : " + str(int(speed)), True, white)
